...
var UserService = /** @class */ (function () {
    ...
    UserService.signup = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            var user, hashedPassword, err_1;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, passwordHash.verify(req.body['password'], user.password)];
                    case 2:
                        isValidUser = _a.sent();
                        if (!isValidUser) return [3 /*break*/, 4];
                        return [4 /*yield*/, jwt.sign({ 'email': user.email, 'id': user._id }, 'testPortal')];
                    case 3:
                        token = _a.sent();
