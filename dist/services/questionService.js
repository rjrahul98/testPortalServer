...
var questionSchema_1 = require("./../dbModels/questionSchema");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        question = questionSchema_1.QuestionModel.questionModel(req.body);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, questionSchema_1.QuestionModel.questionModel.findByIdAndUpdate('id', req.body).exec()];
                    case 1:
                        question = _a.sent();
                        if (question) {
                            question.save();
                            ...
                            return [2 /*return*/, responseService_1.ResponseService.getInValidResponse('email or password is incorrect')];
                        }
                        ;
                        return [3 /*break*/, 3];
                    case 2:
